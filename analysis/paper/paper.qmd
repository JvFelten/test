---
title: "my really awesome Paper"
author:
<<<<<<< HEAD
  - Swe Zin Myint:
=======
  - Jonas Moritz von Felten:
>>>>>>> 49b933fe302d98e0d70cd3cd55f5b391d36ba76c
      correspondence: "yes"
...
csl: "../templates/deutsches-archaologisches-institut_modified_2.csl" # Insert path for the bib-style
abstract: |
  Text of abstract
keywords: |
...
Here is a citation [@Marwick2017] Here is an example of citation @oswald_pryce
...
```{r}
#| label: fig-mtcars-scatter-plot
#| fig-cap: Scatter plot of miles per gallon by horsepower
library(ggplot2)
ggplot(mtcars) +
  aes(mpg, hp) +
  geom_point()
...
Now I am writing about the Figure... In @fig-mtcars-scatter-plot
